...
struct PersistenceController {
    ...
    static var preview: PersistenceController = {
        ...
        let sampleFootstep = Footstep(context: viewContext)
        sampleFootstep.id = UUID()
        sampleFootstep.title = "Kolosseum besucht"
        sampleFootstep.content = "Beeindruckende Architektur und Geschichte"
        sampleFootstep.latitude = 41.8902
        sampleFootstep.longitude = 12.4922
        sampleFootstep.timestamp = Date()
        sampleFootstep.createdAt = Date()
        sampleFootstep.author = sampleUser
        sampleFootstep.trip = sampleTrip
        ...
        samplePhoto.footstep = sampleFootstep
